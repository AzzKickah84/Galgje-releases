...
| File | Description |
|------|-------------|
| [GalgjeSetup_v8.0.14.202606302145.exe](https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302145.exe) | Windows installer (~7.01 MB) |
...
| [CHANGELOG.md](https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302145.exe) | See release assets on [Releases](https://github.com/AzzKickah84/Galgje-releases/releases) |

**Direct installer link:** https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302145.exe
...
SHA-256 (`GalgjeSetup_v8.0.14.202606302145.exe`):

`
077ebb8f16236c4108dbeffeb4327a986d545cf74c6971a50250c04f106b396e
`
