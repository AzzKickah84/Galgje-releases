...
## Latest version (v8.0.14)

| File | Description |
|------|-------------|
| [GalgjeSetup_v8.0.14.202606302220.exe](https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302220.exe) | Windows installer (~7.02 MB) |
...
| [CHANGELOG.md](https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302220.exe) | See release assets on [Releases](https://github.com/AzzKickah84/Galgje-releases/releases) |

**Direct installer link:** https://github.com/AzzKickah84/Galgje-releases/releases/download/v8.0.14/GalgjeSetup_v8.0.14.202606302220.exe
...
SHA-256 (`GalgjeSetup_v8.0.14.202606302220.exe`):

`
9179ae8b2aaf3342a050f40eee60ebc6ecbb2810edd5e7f994c9ed5bbe8f8537
`
